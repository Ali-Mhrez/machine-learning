...
from utils.gradient_descent_multi import gradient_descent_multi
from utils.normal_eqn import normal_eqn
...
price = theta[0] + (((1650 - mu[0]) / sigma[0]) * theta[1]) + (((3 - mu[1]) / sigma[1]) * theta[2]) # You should change this
